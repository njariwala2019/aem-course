...
class RestAPIIntegrationServletTest {
    ...
    RestAPIIntegrationServlet fixture;
    ...
    void setUp(AemContext context) {
        ...
        Mockito.when(customHttpService.makeGetCall("https://api.openweathermap.org/data/2.5/weather",String.class,params))
    ...
    void doGet(AemContext context) throws ServletException, IOException {
        ...
        assertEquals("{ \"hello\": \"world\" }", response.getOutputAsString());
